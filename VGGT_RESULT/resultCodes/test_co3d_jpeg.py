...
def process_sequence(model, seq_name, seq_data, category, co3d_dir, min_num_images, num_frames, use_ba, device, dtype, QP):
    ...
    for i in ids:
        ...
        new_path = f"/home/knuvi/dataset/Blind_images_v2/jpeg/JpegOutput_{QP}/{category}/{seq_name}/images/frame{int(frame_num):06d}_JPEG_Q{QP}.jpg"
...
def main():
    ...
    for QP in QP_list:
        ...
        csv_path = os.path.join(os.path.dirname(args.model_path), f"auc_summary_jpegQ{QP}.csv")
